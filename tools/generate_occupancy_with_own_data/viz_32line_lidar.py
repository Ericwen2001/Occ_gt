...
def main():
    ...
    root_path = "/mnt/data/DataSet/occ_work_dir/LiDAR_32/viz"
    save_img = True
    
    splits = ['15']  # Assuming we only have split '3'
    for split in splits:
        clips = sorted(
        ...
        for clip in clips:
            ...
            vis_path = '/mnt/data/DataSet/viz/32LineLiDAR_predict/{}'.format(split)
